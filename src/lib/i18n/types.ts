...
export interface DictionaryType {
  ...
  admin: {
    ...
    ai: {
      ...
      promptFixSpelling: string;
      promptExpandLesson: string;
      promptSummarize: string;
      promptMakeQuiz: string;
      promptSeoOptimize: string;
      ...
      docFailed: string;
      generateCourseBtn: string;
      generateBlogBtn: string;
      courseWizardTitle: string;
      courseTopicLabel: string;
      courseLevelLabel: string;
      courseTargetAudienceLabel: string;
      startGenerationBtn: string;
  ...
  blog: {
    ...
    relatedCoursesSubtitle: string;
    noRelatedCourses: string;
    relatedPostsTitle: string;
    aboutAuthor: string;
    viewAllPostsByAuthor: string;
  ...
  affiliate: {
    ...
    copyLink: string;
    linkCopied: string;
    generateCourseLink: string;
    selectCoursePlaceholder: string;
    courseLinkCopied: string;
    totalOrders: string;
    lifetimeEarnings: string;
    availableBalance: string;
    pendingBalance: string;
    paidBalance: string;
    requestPayoutBtn: string;
    requestPayoutTitle: string;
    payoutAmountLabel: string;
    bankNameLabel: string;
    bankAccountNoLabel: string;
    bankAccountNameLabel: string;
    submitPayoutBtn: string;
    submittingPayout: string;
    payoutSuccess: string;
    payoutFailed: string;
    minPayoutNotice: string;
    commissionsHistory: string;
