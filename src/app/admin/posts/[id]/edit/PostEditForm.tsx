...
export default function PostEditForm({ post, categories }: PostEditFormProps) {
  ...
  const [tags, setTags] = useState<string[]>(post.tags.map((tg) => tg.name));
    ...
    try {
      const res = await fetch(`/api/admin/posts/${post.id}`, {
        ...
        body: JSON.stringify({
          ...
          status: targetStatus || post.status,
      ...
      toast.success(t.admin.posts.updateSuccess);
        ...
        <div className="flex items-center gap-3">
          {post.status === "PUBLISHED" ? (
            <button
              ...
              className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-slate-800 hover:bg-slate-700 text-slate-300 text-xs font-bold transition-all border border-slate-700 disabled:opacity-50"
            >
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-emerald-500/10 hover:bg-emerald-500/20 text-emerald-400 text-xs font-bold transition-all border border-emerald-500/30 disabled:opacity-50"
            >
            ...
            <div className="space-y-3">
              <div>
                ...
                <input
                  ...
                  placeholder={title || "Tiêu đề chuẩn SEO"}
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder={summary || "Mô tả SEO xuất hiện trên Google..."}
